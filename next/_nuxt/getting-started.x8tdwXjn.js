import{_ as a}from"./code-block.4UrQ-Uj4.js";import{u as m}from"./vue.f36acd1f.nPBu3XaK.js";import{F as r,A as e,G as i,t as p,x as t,y as c,z as o,B as s}from"./entry.IeafeRMX.js";import{V as u}from"./VAlert.IbiUGgFI.js";import{V as d}from"./VContainer.EP1F4As5.js";import"./prism.UZGjXXSc.js";import"./VBtn.qgJBhbvf.js";import"./tag.raXFAgTq.js";import"./resizeObserver.2BDxBgMY.js";/* empty css              */const h=t("i",null,"JSON Layout",-1),_=t("p",null,"Install from npm:",-1),f=t("h2",{class:"text-h4 mb-6"}," Compile at runtime ",-1),g=t("p",null,"This is the simplest way to use VJSF. If you work with static schemas you might want to look into compiling at build time instead.",-1),y=t("pre",null,`<script setup>
...
...
    `,-1),l="Getting started",H={__name:"getting-started",setup(C){return m({title:"VJSF - "+l}),(F,T)=>{const n=a;return p(),r(i(d),{class:"doc-content-page"},{default:e(()=>[t("h1",{class:"text-h2 mb-8"},c(l)),o(i(u),{type:"warning",variant:"outlined",class:"mb-8"},{default:e(()=>[s(" VJSF and its core "),h,s(" are not pre-bundled. They are distributed as pure ESM modules written in JS code with type annotations. The transpiling, tree-shaking, minifying, etc should be performed on your side. ")]),_:1}),_,o(n,null,{default:e(()=>[s("npm install @koumoul/vjsf@next")]),_:1}),f,g,o(n,{language:"markup"},{default:e(()=>[y]),_:1}),b,j,v,o(n,null,{default:e(()=>[w]),_:1}),k,o(n,{language:"markup"},{default:e(()=>[V]),_:1}),x,S,o(n,{language:"js"},{default:e(()=>[J]),_:1})]),_:1})}}};export{H as default};
