...
</template>`,-1);function S(i,J,F,I,T,$){const s=a;return c(),r(m,{class:"doc-content-page"},{default:e(()=>[t("h1",h,p(i.title),1),o(d,{type:"warning",variant:"outlined",class:"mb-8"},{default:e(()=>[n(" VJSF and its core "),_,n(" are not pre-bundled. They are distributed as pure ESM modules written in JS code with type annotations. The transpiling, tree-shaking, minifying, etc should be performed on your side. ")]),_:1}),f,o(s,null,{default:e(()=>[n("npm install @koumoul/vjsf@next")]),_:1}),g,y,o(s,{language:"markup"},{default:e(()=>[b]),_:1}),v,k,w,o(s,null,{default:e(()=>[V]),_:1}),x,o(s,{language:"markup"},{default:e(()=>[j]),_:1})]),_:1})}const D=l(u,[["render",S]]);export{D as default};
