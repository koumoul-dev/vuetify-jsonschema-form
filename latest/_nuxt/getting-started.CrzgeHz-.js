import{_ as l}from"./code-block.CfB6rW3Z.js";import{u as m}from"./vue.f36acd1f.D88Qrh4T.js";import{F as r,A as t,G as i,t as c,x as e,y as p,z as o,B as n}from"./entry.DdPCXnhB.js";import{V as u}from"./VAlert.C4-uLOw7.js";import{V as d}from"./VContainer.BcDCCScL.js";import"./prismeditor.min.BVD1t-TK.js";import"./index.CABw68gA.js";import"./tag.CaEY3LdH.js";import"./VBtn.CeADnk7Z.js";import"./resizeObserver.7Spl-8w1.js";/* empty css              */const h=e("i",null,"JSON Layout",-1),_=e("p",null,"Install from npm:",-1),f=e("h2",{class:"text-h4 mb-6"}," Compile at runtime ",-1),g=e("p",null,"This is the simplest way to use VJSF. If you work with static schemas you might want to look into compiling at build time instead.",-1),y=e("pre",null,`<script setup>
...
...`,-1),C=e("p",null,"When changing these parameters in Vite some caching can create confusion, in this case you can use `vite --force` or remove `node_modules/.cache/vite`.",-1),a="Getting started",L={__name:"getting-started",setup(D){return m({title:"VJSF - "+a}),(F,T)=>{const s=l;return c(),r(i(d),{class:"doc-content-page"},{default:t(()=>[e("h1",{class:"text-h2 mb-8"},p(a)),o(i(u),{type:"warning",variant:"outlined",class:"mb-8"},{default:t(()=>[n(" VJSF and its core "),h,n(" are not pre-bundled. They are distributed as pure ESM modules written in JS code with type annotations. The transpiling, tree-shaking, minifying, etc should be performed on your side. ")]),_:1}),_,o(s,null,{default:t(()=>[n("npm install @koumoul/vjsf")]),_:1}),f,g,o(s,{language:"markup"},{default:t(()=>[y]),_:1}),b,v,j,o(s,null,{default:t(()=>[w]),_:1}),k,o(s,{language:"markup"},{default:t(()=>[V]),_:1}),x,S,o(s,{language:"js"},{default:t(()=>[J]),_:1}),C]),_:1})}}};export{L as default};
