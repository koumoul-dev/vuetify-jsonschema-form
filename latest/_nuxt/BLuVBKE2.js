...
.vjsf-markdown-input.v-theme--dark .EasyMDEContainer .CodeMirror-focused .CodeMirror-selected {
  ...
  `,V=k({props:{modelValue:{type:Object,required:!0},statefulLayout:{type:Object,required:!0}},setup(e,{expose:H}){const{inputProps:i,localData:u}=Z(E(e,"modelValue"),e.statefulLayout),t=e.modelValue.options.pluginsOptions.markdown;return()=>l(G,{modelValue:u.value,label:i.value.label,readOnly:e.modelValue.options.readOnly,messages:e.modelValue.messages,locale:e.modelValue.options.locale??"en",inputProps:i.value??{},autofocus:e.modelValue.autofocus??!1,easyMdeOptions:t?.easyMDEOptions??{},icons:t?.icons??{},cspNonce:t?.cspNonce??"",onBlur:()=>e.statefulLayout.blur(e.modelValue),"onUpdate:modelValue":m=>e.statefulLayout.input(e.modelValue,m)})}});$(V);const W={info:q,nodeComponent:V};export{W as V};
