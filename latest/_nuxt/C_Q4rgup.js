...
}`,-1)])),_:1}),n[13]||(n[13]=t("p",null,[o("Please note that this plugins uses "),t("a",{href:"https://github.com/Ionaru/easy-markdown-editor"},"EasyMDE"),o(" which is a CommonJS dependency. You might need to declare it to your build system. For example with Vite:")],-1)),l(i,null,{default:s(()=>n[3]||(n[3]=[t("pre",null,`optimizeDeps: {
  include: ['easymde']
}
