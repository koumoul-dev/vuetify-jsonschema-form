...
export default {
  ...
  methods: {
    ...
    renderSelectProp(h) {
      ...
      if (this.fromUrlWithQuery || (this.rawSelectItems && this.rawSelectItems.length > 20) || ['autocomplete', 'combobox'].includes(this.display)) {
        tag = this.display === 'combobox' ? 'v-combobox' : 'v-autocomplete'
