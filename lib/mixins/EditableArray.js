export default {
  ...
  methods: {
    renderArrayItemModal(h, item, i) {
      ...
      return h('v-dialog', { props: { value: this.currentDialog === i, closeOnContentClick: false, maxWidth: this.fullOptions.maxDialogWidth }, scopedSlots, on: { 'click:outside': close } }, [
        h('v-card', [
