    ...
    renderColorProp(h) {
      ...
      if (this.fullSchema['x-display'] === 'color-picker') {
        children.push(h('v-menu', {
          ...
          scopedSlots: {
            ...
            default: () => h('color-picker', {
              props: { value: this.value || '', presetColors: this.fullOptions.colors.swatches },
        ...
        children.push(h('swatches', {
          props: { value: this.value || '', disabled: this.disabled, colors: this.fullOptions.colors, triggerStyle: { width: '36px', height: '36px' }, shapes: 'circles' },
