      ...
      if (this.fullSchema['x-display'] === 'expansion-panels') {
        ...
        return [h('v-layout', { attrs: { row: true, wrap: true }, class: `ma-0 ${this.fullOptions.sectionsClasses}` }, [
          h('span', {
            ...
            class: 'pt-2 ' + (this.fullOptions.sectionsTitlesClasses[this.sectionDepth] || this.fullOptions.sectionsTitlesClasses[this.fullOptions.sectionsTitlesClasses.length - 1])
