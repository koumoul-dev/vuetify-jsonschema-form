import { VBtn, VContainer, VTextField, VTextarea, VCheckbox, VCombobox, VExpansionPanels, VTabs, VFlex, VMenu, VTimePicker, VDatePicker, VCard, VIcon, VDialog, VChip, VAvatar, VSpacer, VSelect } from 'vuetify/lib'
...
export default {
  name: 'Property',
  components: { VBtn, VContainer, VTextField, VTextarea, VCheckbox, VCombobox, VExpansionPanels, VTabs, VFlex, VMenu, VTimePicker, VDatePicker, VCard, VIcon, VDialog, VChip, VAvatar, VSpacer, VSelect },
