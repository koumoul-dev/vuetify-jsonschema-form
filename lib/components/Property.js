...
let components = {}
// requiring each used component of vuetify to try working well with vuetify-loader
// except in the context of the jest tests
console.log('global', global.test)
if (!global.afterAll) {
  const { VAvatar, VBtn, VCard, VCardActions, VCardText, VCardTitle, VCheckbox, VChip, VCombobox, VContainer, VDatePicker, VDialog, VExpansionPanels, VExpansionPanel, VExpansionPanelHeader, VExpansionPanelContent, VFlex, VIcon, VInput, VLayout, VMenu, VSelect, VSpacer, VSubheader, VTabs, VTab, VTabItem, VTextarea, VTextField, VTimePicker, VTooltip } = require('vuetify/lib')
  components = { VAvatar, VBtn, VCard, VCardActions, VCardText, VCardTitle, VCheckbox, VChip, VCombobox, VContainer, VDatePicker, VDialog, VExpansionPanels, VExpansionPanel, VExpansionPanelHeader, VExpansionPanelContent, VFlex, VIcon, VInput, VLayout, VMenu, VSelect, VSpacer, VSubheader, VTabs, VTab, VTabItem, VTextarea, VTextField, VTimePicker, VTooltip }
}
...
export default {
  ...
  props: ['schema', 'value', 'modelRoot', 'modelKey', 'parentKey', 'required', 'options', 'sectionDepth'],
  data() {
    return {
      ready: false,
      loading: false,
  ...
  computed: {
    fullSchema() {
      return schemaUtils.prepareFullSchema(this.schema, this.value)
    },
    htmlDescription() {
    ...
    disabled() {
      return this.options.disableAll || this.fullSchema.readOnly
    },
    slotName() {
    ...
    commonFieldProps() {
      return {
        ...
        rules: this.rules,
        required: this.required,
        dense: this.options.dense || this.disabled,
