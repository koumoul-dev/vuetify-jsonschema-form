...
export default function (nodeRef, statefulLayout) {
  ...
  const { inputProps, options, skeleton, modelValue, compSlots } = useField(nodeRef, statefulLayout, { layoutPropsMap: ['multiple'], bindData: false })
  ...
  return { modelValue, inputProps, selectProps, compSlots, selectSlots, getItems }
}
