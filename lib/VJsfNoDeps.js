...
export default {
  ...
  render(h) {
    ...
    if (!this.fullSchema || this.fullSchema.const !== undefined || this.fullSchema.visible === false || this.display === 'hidden' || (this.fullSchema.readOnly && this.fullOptions.hideReadOnly)) {
      return
    }
