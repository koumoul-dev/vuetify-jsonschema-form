...
export default {
  ...
  computed: {
    ...
    label() {
      ...
      if (this.fullSchema.readOnly && this.fullOptions.hideReadOnlyLabels) return
  ...
  render(h) {
    ...
    if (this.fullSchema.readOnly && this.fullOptions.hideReadOnlyEmpty && [null, undefined, ''].includes(this.value)) return
