...
exports.prepareFullSchema = (schema, modelWrapper, modelKey) => {
...
exports.getRules = (fullSchema, required, options) => {
  const rules = []
  if (required) {
  ...
  const oneOfSelect = exports.isOneOfSelect(fullSchema)
...
exports.isOneOfSelect = (fullSchema) => {
