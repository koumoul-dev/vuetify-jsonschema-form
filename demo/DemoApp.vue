        ...
        <v-layout row>
          ...
          <v-flex xs6>
            ...
            <v-form v-model="formValid">
              <v-jsonschema-form v-if="schema" :schema="schema" :model="dataObject" :options="{debug: true, disableAll: false, context: {owner: {type: 'organization', id: '5a5dc47163ebd4a6f438589b'}}, autoFoldObjects: true}" @error="e => window.alert(e)" />
            </v-form>
